...
- 6 read tools: `list_worlds`, `list_resources`, `get_resource`, `get_resource_tree`, `search_content`, `get_calendar`
...
| Tool | Description |
|------|-------------|
| `list_worlds` | List loaded worlds with resource/calendar counts |
